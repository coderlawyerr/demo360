...
//   final List<UyegruplariElement>? uyegruplari;
...
//             ? []
//             : List<UyegruplariElement>.from(
//                 json["uyegruplari"]!.map((x) => UyegruplariElement.fromMap(x))),
...
// class UyegruplariElement {
//   final int? grupId;
//   final dynamic ekleyenId;
...
//     this.kayitolacaklar,
//   });
//   factory UyegruplariElement.fromJson(Map<String, dynamic> json) =>
//       UyegruplariElement.fromMap(json);

//   String toJson() => json.encode(toMap());

//   factory UyegruplariElement.fromMap(Map<String, dynamic> json) => UyegruplariElement(
//         grupId: json["grup_id"],
